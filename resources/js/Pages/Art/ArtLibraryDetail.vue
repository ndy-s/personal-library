    ...
    <Layout>
        ...
        <div class="lg:hidden mt-20 px-4 pb-10">
            ...
            <div class="relative w-full md:w-1/2 md:mx-auto aspect-[2/3] mt-6 rounded-2xl shadow-2xl overflow-hidden ring-1 ring-white/10">
                ...
                <img :src="`/img/library/${ArtLibrary.image_path}`" class="w-full h-full object-cover" @click="openModal()">
            </div>
            ...
            <div class="mt-6">
                ...
                <div class="flex flex-wrap items-center gap-2 mt-3">
                    <span class="inline-block text-emerald-300 bg-emerald-900/40 px-3 py-1 border border-emerald-500/30 rounded-full text-xs font-bold shadow-sm backdrop-blur-sm">{{ ArtLibrary.type }}</span>
            ...
            <div class="mt-8 bg-gray-800/40 rounded-xl p-5 border border-white/5 shadow-inner">
                ...
                <div class="space-y-3 text-sm text-gray-300">
                    <div class="flex justify-between border-b border-gray-700/50 pb-2">
                        <span class="text-gray-500">Title (JP)</span>
                        <span class="text-right">{{ ArtLibrary.title_jp }}</span>
                    </div>
                    <div class="flex justify-between border-b border-gray-700/50 pb-2">
                    ...
                    <div class="flex justify-between border-b border-gray-700/50 pb-2">
                        ...
                        <span class="text-right">{{ ArtLibrary.studio }}</span>
                    </div>
                    <div class="flex justify-between border-b border-gray-700/50 pb-2">
        ...
        <div class="hidden lg:block mt-16 relative w-[100%] h-auto">
            ...
            <div class="absolute top-0 mx-[27%] my-20 leading-7 w-[50%]">
                ...
                <span class="inline-block cursor-default text-emerald-300 bg-emerald-900/40 px-3 py-1 border border-emerald-500/30 rounded-full text-xs font-bold shadow-sm backdrop-blur-sm">{{ ArtLibrary.type }}</span>

                <table class="text-white mt-3">
                    <tr><td class="font-semibold">Title (Romaji)</td><td> : {{ ArtLibrary.title_jp }}</td></tr>
                    <tr><td class="font-semibold">Original</td><td> : {{ ArtLibrary.original }}</td></tr>
                    <tr><td class="font-semibold">Series</td><td> : {{ ArtLibrary.series }}</td></tr>
                    <tr><td class="font-semibold">Author / Character Designer</td><td> : {{ ArtLibrary.author }}</td></tr>
                    <tr><td class="font-semibold">Studio</td><td> : {{ ArtLibrary.studio }}</td></tr>
                    ...
                    <tr><td class="font-semibold">Page</td><td> : {{ ArtLibrary.page }}</td></tr>
            ...
            <div class="absolute top-0 w-[15%] h-[80%] mx-[10%] mt-14 rounded-lg">
                <img :src="`/img/library/${ArtLibrary.image_path}`" class="h-full w-full object-cover rounded-lg cursor-pointer shadow-2xl transition hover:scale-[1.02]" @click="openModal()">
            </div>
