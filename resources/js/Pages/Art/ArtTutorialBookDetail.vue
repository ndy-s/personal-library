<template>
    <Layout>
        ...
        <div class="lg:hidden mt-20 px-4 pb-10">
            <DetailBackButton linkHref="/art-tutorial-book" />
            ...
            <div class="relative w-full md:w-1/2 md:mx-auto aspect-[2/3] mt-6 rounded-2xl shadow-2xl overflow-hidden ring-1 ring-white/10">
                ...
                <img :src="`/img/tutorial-book/${ArtLibrary.image_path}`" class="w-full h-full object-cover" @click="openModal()">
            </div>
            ...
            <div class="mt-8 bg-gray-800/40 rounded-xl p-5 border border-white/5 shadow-inner">
                ...
                <div class="space-y-3 text-sm text-gray-300">
                    ...
                    <div class="flex justify-between border-b border-gray-700/50 pb-2">
                        ...
                        <span class="text-right">{{ ArtLibrary.page }}</span>
                    </div>
                    <div class="pt-2">
        ...
        <div class="hidden lg:block mt-16 relative w-[100%] h-auto">
            <img :src="`/img/tutorial-book/${ArtLibrary.image_path}`" class="w-[100%] h-[60vh] object-cover blur-2xl z-[-10] clip-path opacity-50">
            <DetailBackButton linkHref="/art-tutorial-book"/>
            ...
            <div class="absolute top-0 w-[15%] h-[80%] mx-[10%] mt-14 rounded-lg">
                <img :src="`/img/tutorial-book/${ArtLibrary.image_path}`" class="h-full w-full object-cover rounded-lg cursor-pointer shadow-2xl transition hover:scale-[1.02]" @click="openModal()">
            </div>
        ...
        <div class="flex flex-col xl:flex-row bottom-0">
            ...
            />
            <DataRecentList imgSrc="tutorial-book" :recent="recent" />
        </div>
        ...
        <Transition>
            <div v-if="showModal" @click="closeModal" class="fixed inset-0 flex items-center justify-center z-50 bg-opacity-50 bg-black transition-all ease-in-out duration-500">
                <div class="bg-white p-4 rounded shadow">
                    <img :src="`/img/tutorial-book/${ArtLibrary.image_path}`" class="w-full h-auto">
                </div>
            </div>
        </Transition>
